...
2. **Scalp Mask Processing**:
   - The UV coordinate is mapped to a pixel coordinate on a `<canvas>` containing [scalp_mask.jpeg](file:///c:/Users/Cinna/Desktop/dev/hair-calculator-app/public/textures/scalp_mask.jpeg).
   - **RGB classification**:
