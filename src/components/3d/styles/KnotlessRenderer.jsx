...
/**
 * KnotlessRenderer component renders instanced 3D hair segments for Box Braids
 ...
 */
export function KnotlessRenderer({ stylePos, lengthPos, thicknessPos, hairPlacementPoints }) {
