...
/**
 * LocsRenderer component renders instanced 3D hair segments for Box Braids
 ...
 */
export function LocsRenderer({ stylePos, lengthPos, thicknessPos, hairPlacementPoints }) {
